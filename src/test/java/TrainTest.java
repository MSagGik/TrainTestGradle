...
class TrainTest {
    ...
    public void examinationConstructorAndGet() {
        ...
        //assertEquals(LocalDateTime.parse("10:00 25.11.2022", DateTimeFormatter.ofPattern("HH:mm dd.MM.yyyy")), trainTwo.getDepartureDateOriginal());
        //assertNotEquals(LocalDateTime.parse("12:00 25.11.2022", DateTimeFormatter.ofPattern("HH:mm dd.MM.yyyy")), trainTwo.getArrivalDateOriginal());
        assertEquals("10:00 25.11.2022", trainTwo.getDepartureDate());
        assertNotEquals("14:00 25.11.2022", trainTwo.getArrivalDate());
    }
    ...
    public void whenDataIsIncorrect_ExceptionIsThrown(String name, String departurePoint, String placeOfArrival,
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            ...
            Train train = new Train(name,departurePoint, placeOfArrival, departureDateString, arrivalDateString, distance);
        });
